...
<body>
    ...
    <div class="homescreens2">
        ...
        <div class="kontenhs2">
            ...
            <div class="kontenhs3">
                <img src="img/shopping-cart-add.png" alt="time" style="width: 100px; height: 100px; margin-bottom: 50px;">
                <h4>Pemesanan Pupuk Mudah & Terjangkau</h4>
            </div>
            <div class="kontenhs3">
                <img src="img/handshake.png" alt="time" style="width: 100px; height: 100px; margin-bottom: 50px;">
