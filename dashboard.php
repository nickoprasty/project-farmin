        ...
        <table class="tabelItem">
            ...
            <tbody class="tbodyItem">
                ...
                <tr>
                    ...
                    <td><a  href="ubahItem.php" class="btnAksi aksiUbah" style="text-decoration: none; background-color: #37a46d; border-radius: 10px; display: inline-block; padding: 5px; width: 50px; color: white;">Edit</a> 
                        <a  href="hapusItem.php" class="btnAksi aksiDelete" style="text-decoration: none; background-color: #37a46d; border-radius: 10px; display: inline-block; padding: 5px; width: 50px; color: white;">Delete</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
